...
class Utility extends Component {
	...
	*/
	...
	/**
	* this function is used check is Secretary login
	*@author Hemant Thakur
	*@return boolean
	*/
	public function isSecretaryLogin(){
		$session = Yii::$app->getSession();
	...
	/**
	* this function is used check is Chief Secretary login
	*@author Hemant Thakur
	*@return boolean
	*/
	public function isChiefSecretaryLogin(){
		$session = Yii::$app->getSession();
	...
	/**
	* this function is used check is Admin login
	*@author Hemant Thakur
	*@return boolean
	*/
	...
	/**
	* this function is used check is super admin login
	*@author Hemant Thakur
	*@return boolean
	*/
