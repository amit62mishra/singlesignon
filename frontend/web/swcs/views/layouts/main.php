  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      <header class="main-header">
        <a href="<?=Yii::app()->createAbsoluteUrl('/backoffice/frontuser')?>" class="logo">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">
                    <?php 
                      @session_start();
                      if(isset($_SESSION['RESPONSE']['first_name']) && $_SESSION['RESPONSE']['first_name'])
                        echo $_SESSION['RESPONSE']['first_name']." ".$_SESSION['RESPONSE']['last_name'];
                      else if(DefaultUtility::isValidDepartmentLogin())
                        echo $_SESSION['uname'].'<b class="caret"></b>';
                      else
                        echo "Login";
                    ?>
                  </span>
                    ...
                    <ul class="dropdown-menu">
                      <li class="user-footer">
                        <?php if(isset($_SESSION['RESPONSE']['first_name']) && $_SESSION['RESPONSE']['first_name'] || DefaultUtility::isValidDepartmentLogin()){ ?>
                          <div class="pull-left">
                            <a href="<?=Yii::app()->createAbsoluteUrl('Profile/user')?>" class="btn btn-default btn-flat">Profile</a>
                          </div>
      ...
      <?php 
        if(DefaultUtility::isValidDepartmentLogin() && RolesExt::isAdminUser())
           require_once('admin.php');
        elseif(DefaultUtility::isInvestorLoggedIn())
           require_once('investor.php');
        elseif (DefaultUtility::isValidDepartmentLogin() && DefaultUtility::isSuperAdmin()) 
           require_once('superadmin.php');
        elseif(RolesExt::isSSOAdmin())
           require_once('ssoAdmin.php');
        elseif(DefaultUtility::isValidDepartmentLogin()) 
      ...
      <footer class="main-footer">
        ...
        <strong><a href="http://emerginghimachal.hp.gov.in">Department of Industries</a> &copy; 2018.</strong>
        reserved.
      </footer>
    </div>
