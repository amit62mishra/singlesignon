...
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementArray.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementBoolean.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementDate.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementHexa.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementName.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementNull.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementNumeric.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementString.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementXRef.php');
