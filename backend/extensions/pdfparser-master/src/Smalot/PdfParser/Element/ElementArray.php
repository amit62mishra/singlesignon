...
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Document.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Header.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/PDFObject.php');
