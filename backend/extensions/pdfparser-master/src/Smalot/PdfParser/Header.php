...
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementMissing.php');
require_once(Yii::app()->basePath.'/extensions/pdfparser-master/src/Smalot/PdfParser/Element/ElementStruct.php');
